...
class MdColor(
    ...
    companion object {
        ...
        val DeepPurple = MdColor(ColorGradient(
        ...
        val LightBlue = MdColor(ColorGradient(
        ...
        val LightGreen = MdColor(ColorGradient(
        ...
        val DeepOrange = MdColor(ColorGradient(
        ...
        val BlueGrey = MdColor(ColorGradient(
